...
projectname="Hyper_CL_PDCs2018_expression" # CHANGE THIS - name you want to give to your W&B project
foldername="CL_PDCs2018_expression" 
...
genomics_name="cell2expression"$type".txt"

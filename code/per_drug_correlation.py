...
# parser.add_argument('-input_folder', help='Directory containing the input data folders.', type=str, default=computer+"SparseGO_code/data/PDCs2018_mutations_LECO/")
# parser.add_argument('-output_folder', help='Directory containing the folders that have the resulting models', type=str, default=computer+"SparseGO_code/results/PDCs2018_mutations_LECO/")
# parser.add_argument('-samples_folders', help='Folders to analyze', type=str, default=["samples1","samples2","samples3","samples4","samples5"])
# #parser.add_argument('-samples_folders', help='Folders to analyze', type=str, default=["samples1","samples2"])
# parser.add_argument('-txt_type', help='If txts of data have a particular extra name', type=str, default="_PDCs2018")
# parser.add_argument('-model_name', help='Model to use to compute individual drug predictions', type=str, default="best_model_d.pt")
# parser.add_argument('-predictions_name', help='Which results to use for the density plot', type=str, default="ModelPerDrug_test_predictions.txt")
# parser.add_argument('-labels_name', help='Which results to use for the density plot', type=str, default="sparseGO_test.txt")
# parser.add_argument('-ontology_name', help='Which results to use for the density plot', type=str, default="sparseGO_ont_PDCs2018.txt")
# parser.add_argument('-genomics_name', help='Which results to use for the density plot', type=str, default="cell2mutation_PDCs2018.txt")
# parser.add_argument('-gene2id', help='Which results to use for the density plot', type=str, default="gene2ind_PDCs2018.txt")
# parser.add_argument('-druginput_name', help='Which results to use for the density plot', type=str, default="drug2selfieslatent200_PDCs2018.txt")
# parser.add_argument('-cuda', help='Cuda ID', type=str, default=0)
# parser.add_argument('-project', help='W&B project name', type=str, default="PDCs2018_mutations_LECO_final")

# parser.add_argument('-input_folder', help='Directory containing the input data folders.', type=str, default=computer+"SparseGO_code/data/PDCs2018_expression_LECO/")
# parser.add_argument('-output_folder', help='Directory containing the folders that have the resulting models', type=str, default=computer+"SparseGO_code/results/PDCs2018_expression_LECO/")
# parser.add_argument('-samples_folders', help='Folders to analyze', type=str, default=["samples1","samples2","samples3","samples4","samples5"])
# #parser.add_argument('-samples_folders', help='Folders to analyze', type=str, default=["samples1","samples2"])
# parser.add_argument('-txt_type', help='If txts of data have a particular extra name', type=str, default="_PDCs2018")
# parser.add_argument('-model_name', help='Model to use to compute individual drug predictions', type=str, default="best_model_d.pt")
...
# parser.add_argument('-labels_name', help='Which results to use for the density plot', type=str, default="sparseGO_test.txt")
# parser.add_argument('-ontology_name', help='Which results to use for the density plot', type=str, default="sparseGO_ont_PDCs2018.txt")
# parser.add_argument('-genomics_name', help='Which results to use for the density plot', type=str, default="cell2expression_PDCs2018.txt")
# parser.add_argument('-gene2id', help='Which results to use for the density plot', type=str, default="gene2ind_PDCs2018.txt")
# parser.add_argument('-druginput_name', help='Which results to use for the density plot', type=str, default="drug2selfieslatent200_PDCs2018.txt")
# parser.add_argument('-cuda', help='Cuda ID', type=str, default=0)
# parser.add_argument('-project', help='W&B project name', type=str, default="PDCs2018_expression_LECO_final")

parser.add_argument('-input_folder', help='Directory containing the input data folders.', type=str, default=computer+"SparseGO_code/data/PDCs2018_multiomics_LELO/")
parser.add_argument('-output_folder', help='Directory containing the folders that have the resulting models', type=str, default=computer+"SparseGO_code/results/PDCs2018_multiomics_LELO/")
parser.add_argument('-samples_folders', help='Folders to analyze', type=str, default=["samples1","samples2","samples3","samples4","samples5"])
#parser.add_argument('-samples_folders', help='Folders to analyze', type=str, default=["samples1"])
parser.add_argument('-txt_type', help='If txts of data have a particular extra name', type=str, default="")
parser.add_argument('-model_name', help='Model to use to compute individual drug predictions', type=str, default="best_model_d.pt")
parser.add_argument('-predictions_name', help='Which results to use for the density plot', type=str, default="ModelPerDrug_test_predictions.txt")
parser.add_argument('-labels_name', help='Which results to use for the density plot', type=str, default="sparseGO_test.txt")
parser.add_argument('-ontology_name', help='Which results to use for the density plot', type=str, default="sparseGO_ont.txt")
...
parser.add_argument('-cuda', help='Cuda ID', type=str, default=0)
parser.add_argument('-project', help='W&B project name', type=str, default="PDCs2018_multiomics_LELO_final")
...
for folder in opt.samples_folders:
    ...
    drug2fingerprint=inputdir+opt.druginput_name
...
plt.text(0.45, 0.18, "Overall spearman corr. = "+str(sp_overall), fontsize=13,color='#333333',weight='bold')
plt.text(0.45, 0.14, "Overall pearson corr. = "+str(pe_overall), fontsize=13,color='#333333',weight='bold')
plt.text(0.45, 0.10, "Overall MSE loss = "+str(loss_overall), fontsize=13,color='#333333',weight='bold')

plt.text(0.45, 0.06, "Average spearman corr. = "+str(sp_average), fontsize=13,color='#333333',weight='bold')
plt.text(0.45, 0.02, "Average pearson corr. = "+str(pe_average), fontsize=13,color='#333333',weight='bold')
